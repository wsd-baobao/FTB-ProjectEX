...
//        ConfigHelper.client().general.overrideEMCFormatter.get() &&
        if ( number >= 1_000_000D && (ignoreShift || !Screen.hasShiftDown())) {
            double num;
            char c;
...
//        ProjectEX.LOGGER.info(" 显示一些参数 {},{},{} " ,number,result ,fieldPosition);
//        ProjectEX.LOGGER.info(ConfigHelper.client().general.overrideEMCFormatter.get() );
//
//        ProjectEX.LOGGER.info(number >= 1_000_000L );
//        ProjectEX.LOGGER.info((ignoreShift || !Screen.hasShiftDown()) );
//        ConfigHelper.client().general.overrideEMCFormatter.get()
        if (  number >= 1_000_000L && (ignoreShift || !Screen.hasShiftDown())) {
            double num;
            char c;
