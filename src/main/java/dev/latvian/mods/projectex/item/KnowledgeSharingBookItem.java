...
public class KnowledgeSharingBookItem extends Item {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TranslatableComponent("item.projectex.knowledge_sharing_book.tooltip.1").withStyle(ChatFormatting.GRAY));
		list.add(new TranslatableComponent("item.projectex.knowledge_sharing_book.tooltip.2").withStyle(ChatFormatting.GRAY));
	}
...
//        }
		...
		if (!level.isClientSide()) {
			...
			player.displayClientMessage(new TranslatableComponent("item.projectex.knowledge_sharing_book.learned", nLearned)
